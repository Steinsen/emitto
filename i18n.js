...
const STRINGS = {
  sv: {
    ...
    coachWorking: 'Hämtar den avancerade analysen…',
    ...
    shareNote: 'Bilden och sidan skapas på din enhet.',
    ...
    footer: 'Mätningen körs i din webbläsare, den avancerade analysen i en Worker.',
    langLabel: 'Språk',
  },
  en: {
    tag: 'Shot analysis',
    ...
    coachWorking: 'Fetching the advanced analysis…',
    ...
    shareNote: 'The image and the page are made on your device.',
    ...
    footer: 'The measuring runs in your browser, the advanced analysis in a Worker.',
    langLabel: 'Language',
  },
};
