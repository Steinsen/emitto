...
const STRINGS = {
  sv: {
    ...
    drill: 'Övning',
    newClip: 'Nytt klipp',
    shareImage: 'Spara eller dela bild',
    shareText: 'Spara eller dela text',
    shareWorking: 'Gör filen…',
    shareNote: 'Bilden och texten skapas på din enhet.',
  ...
  en: {
    ...
    drill: 'Drill',
    newClip: 'New clip',
    shareImage: 'Save or share the image',
    shareText: 'Save or share the text',
    shareWorking: 'Making the file…',
    shareNote: 'The image and the text are made on your device.',
