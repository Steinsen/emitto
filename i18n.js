...
const STRINGS = {
  sv: {
    ...
    loadingMeasure: 'Mäter vinklar och tider.',
    loadingFrames: 'Ritar faserna.',
    loadingCoach: 'Frågar en skottexpert om helheten.',
    ...
    disagreementTitle: 'En invändning mot listan',
    writtenBy: 'Texten är skriven av en språkmodell utifrån mätvärdena; ordningen i listan kommer från riktvärdena.',
    reference: 'riktvärde',
    ...
    shareText: 'Dela beskrivning',
    shareWorking: 'Gör filen…',
    shareNote: 'Bilden visar faserna med vinklarna. Beskrivningen är hela texten. Båda skapas på din enhet.',
    shareFailed: 'Det gick inte att skapa filen. Prova igen.',
    shareCopied: 'Texten är kopierad – klistra in den i chatten.',
    shareDownloaded: 'Texten är sparad som en fil.',
  ...
  en: {
    ...
    loadingMeasure: 'Measuring angles and timings.',
    loadingFrames: 'Drawing the phases.',
    loadingCoach: 'Asking a shooting coach about the whole thing.',
    ...
    disagreementTitle: 'An objection to the list',
    writtenBy: 'The text is written by a language model from the measurements; the order of the list comes from the reference values.',
    reference: 'reference',
    within: 'within range',
    tooLow: 'below range',
    tooHigh: 'above range',
    ...
    shareText: 'Share description',
    shareWorking: 'Making the file…',
    shareNote: 'The image shows the phases with the angles. The description is the whole text. Both are made on your device.',
    shareFailed: 'Could not create the file. Try again.',
    shareCopied: 'The text is copied – paste it into the chat.',
    shareDownloaded: 'The text is saved as a file.',
