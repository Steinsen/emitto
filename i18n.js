...
const STRINGS = {
  sv: {
    ...
    framesHint: 'Då skickas några beskurna stillbilder på spelaren tillsammans med siffrorna, så att analysen kan säga något om följning, stödhand och landning. Klippet skickas aldrig – det lämnar aldrig din enhet.',
  ...
  en: {
    ...
    framesHint: 'A few cropped stills of the player are then sent along with the numbers, so the analysis can say something about the follow-through, the guide hand and the landing. The clip is never sent – it never leaves your device.',
