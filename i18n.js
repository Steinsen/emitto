...
const STRINGS = {
  sv: {
    ...
    ageLabel: 'Ålder',
    ageHint: 'Frivilligt. Påverkar bara hur texten formuleras – aldrig riktvärdena eller ordningen.',
    coachWorking: 'Skriver en sammanhängande text utifrån mätvärdena…',
    coachBadge: 'AI-formulerad',
    coachNote: 'Texten är formulerad av en språkmodell utifrån mätvärdena. Ordningen kommer från riktvärdena och ändras aldrig.',
    coachFailed: 'Den AI-formulerade texten gick inte att hämta. Riktvärdenas egen text står kvar.',
    advancedTitle: 'Avancerad analys',
    framesLabel: 'Skicka bildrutor för bättre analys',
    framesHint: 'Då laddas fyra–fem beskurna stillbilder på spelaren upp tillsammans med siffrorna och skickas vidare till en språkmodell, så att analysen kan säga något om följning, stödhand och landning. Bilderna sparas inte. Klippet laddas aldrig upp – det lämnar aldrig din enhet.',
    framesDefault: 'Utan kryss skickas bara mätvärdena – siffrorna, inga bilder. Analysen fungerar ändå.',
    afterTitle: 'Efter släppet',
    afterNote: 'Det här ligger utanför riktvärdena i listan ovan – det är modellens egen bedömning av det vi mätt efter släppet.',
    strengthsTitle: 'Det här sitter',
    observationsTitle: 'Sett i bilderna',
    observationsNote: 'Observationer, inte mätvärden.',
    uncertaintiesTitle: 'Så säkert är det mätt',
    disagreementTitle: 'Modellens invändning mot listan',
    reference: 'riktvärde',
    ...
    shareReport: 'Spara som sida',
    shareWorking: 'Gör filen…',
    shareNote: 'Bilden och sidan skapas på din enhet – klippet laddas fortfarande inte upp någonstans.',
    shareFailed: 'Det gick inte att skapa filen. Prova igen.',
    ...
    errVideo: 'Webbläsaren kan inte spela upp det klippet. iPhone spelar in i HEVC, som Chrome och Firefox ofta inte klarar. Exportera klippet som H.264 eller öppna sidan i Safari.',
    errExample: 'Kunde inte hämta exempelklippet.',
    examplesTitle: 'Eller titta på ett färdigt exempel',
    loadingExample: 'Hämtar exempelklippet.',
    ...
    footer: 'Analysen körs i din webbläsare. Klippet laddas aldrig upp någonstans – bara mätvärdena, för att texten ska kunna formuleras.',
    langLabel: 'Språk',
  },
  en: {
    tag: 'Shot analysis',
    ...
    ageLabel: 'Age',
    ageHint: 'Optional. It only affects how the text is worded – never the reference values or the order.',
    coachWorking: 'Writing a connected text from the measurements…',
    coachBadge: 'AI-worded',
    coachNote: 'The text is worded by a language model from the measurements. The order comes from the reference values and never changes.',
    coachFailed: 'The AI-worded text could not be fetched. The reference-value text stands.',
    advancedTitle: 'Advanced analysis',
    framesLabel: 'Send still frames for a better analysis',
    framesHint: 'Four or five cropped stills of the player are then uploaded along with the numbers and passed to a language model, so the analysis can say something about the follow-through, the guide hand and the landing. The images are not stored. The clip is never uploaded – it never leaves your device.',
    framesDefault: 'Unticked, only the measurements are sent – the numbers, no images. The analysis still works.',
    afterTitle: 'After the release',
    afterNote: 'This sits outside the reference values in the list above – it is the model’s own reading of what we measured after the release.',
    strengthsTitle: 'This is holding up',
    observationsTitle: 'Seen in the frames',
    observationsNote: 'Observations, not measurements.',
    uncertaintiesTitle: 'How firmly this is measured',
    disagreementTitle: 'The model’s objection to the list',
    reference: 'reference',
    within: 'within range',
    tooLow: 'below range',
    tooHigh: 'above range',
    ...
    shareReport: 'Save as a page',
    shareWorking: 'Making the file…',
    shareNote: 'The image and the page are made on your device – the clip is still never uploaded anywhere.',
    shareFailed: 'Could not create the file. Try again.',
    ...
    errVideo: 'Your browser cannot play that clip. iPhones record in HEVC, which Chrome and Firefox often cannot decode. Export the clip as H.264, or open this page in Safari.',
    errExample: 'Could not fetch the example clip.',
    examplesTitle: 'Or look at a finished example',
    loadingExample: 'Fetching the example clip.',
    ...
    footer: 'The analysis runs in your browser. The clip is never uploaded anywhere – only the measurements, so the text can be written.',
    langLabel: 'Language',
  },
};
